...
export const CATEGORIES = [
  { id: "breaking", name: "Breaking", color: "breaking" },
  { id: "world", name: "World", color: "world" },
...
export const MOCK_ARTICLES: Article[] = [
  ...
  {
    id: "5",
    title: "Championship Finals Set: Historic Matchup Promises Thrilling Showdown",
    summary: "Two legendary teams prepare for what analysts are calling 'the game of the decade' with unprecedented stakes and storylines.",
    category: "sports",
    region: "us",
    source: "ESPN",
    publishedAt: new Date(Date.now() - 1000 * 60 * 60 * 6),
    imageUrl: "https://images.unsplash.com/photo-1461896836934- voices-of-the-void?w=800&auto=format&fit=crop",
    url: "#",
    readTime: 4,
    isTrending: true,
  },
  ...
  },
  {
    ...
    summary: "Industry insiders react to unexpected choices as streaming platforms dominate this year's major award categories.",
  ...
  },
  {
    ...
    summary: "Scientists achieve a major breakthrough in quantum computing, paving the way for practical applications in drug discovery and cryptography.",
    category: "technology",
    region: "europe",
